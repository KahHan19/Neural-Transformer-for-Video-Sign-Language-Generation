...
from dw_plot_video import plot_video,alter_DTW_timing
...
class TrainManager:
        ...
        for epoch_no in range(self.epochs):
            ...
            for batch in iter(train_iter):
                ...
                if self.steps % self.validation_freq == 0 and update:
                    ...
                    # write_file = "chicken.txt"

                    # with open(write_file, "a") as w:
                    #     frame_joints = valid_hypotheses[:-1]*100
                    #     w.write(len(frame_joints))
    ...
    def dw_validation_video(self,output_joints, inputs, references, display, model_dir, type, steps="", file_paths=None):
